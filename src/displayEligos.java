...
public class displayEligos extends JFrame {
	...
	double[] eligosStar = {1.1670, 1.1670, 1.1670 , 1.1670};
	...
	public displayEligos() throws FileNotFoundException, IOException {
		...
		starIcon.setBounds(450, 0, 70, 70);
		...
		starIcon1.setBounds(450, 0, 70, 70);
		...
		downStar.setBounds(558, 0, 42, 42);
		mainPanel.add(downStar);

		ImageIcon iconStar2 = new ImageIcon("Images/downArrow.png");
		JButton upStar = new JButton(iconStar2);
		upStar.setBounds(600, 0, 42, 42);
		mainPanel.add(upStar);
		// SizeHeight)
		ImageIcon icon = new ImageIcon("Images/downArrow.png");
		JButton downButton = new JButton(icon);
		downButton.setBounds(558, 65, 42, 42);
		mainPanel.add(downButton);

		ImageIcon icon2 = new ImageIcon("Images/downArrow.png");
		JButton upButton = new JButton(icon2);
		upButton.setBounds(600, 65, 42, 42);
		...
		mainPanel.add(spd);
			...
			upStar.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					starIcon1.setBounds(500, 0, 70, 70);
